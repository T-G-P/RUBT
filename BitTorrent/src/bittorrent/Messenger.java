  ...
  public Piece checkResponse() throws IOException {
    ...
    if (length > 0) {
      ...
      if (message_id == 6) {
        ...
        // payload is null since we aren't getting anything from the person
        // requesting the file
      ...
      if (message_id == 7) {
        ...
        Piece piece = new Piece(payload, index, offset, this.requestedPieceLength,
            (length - 9));
        ++count;
        return piece;
